...
**Related:** [Design-022 Page-Aware Copilot Sidebar](./022-galaxy-map-copilot.md), [Design-041 SP-4 Page Control via AGUI Frontend Tools](./041-sp-4-page-control-agui-frontend-tools.md), [Spec 002 SP-4 Wookieepedia Article Modal](../../specs/002-sp4-wookieepedia-modal/spec.md)
