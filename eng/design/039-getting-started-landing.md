...
**Related:** [Design-037 Misc site-activity dashboard](./037-misc-site-activity-dashboard.md), [ADR-009 public read-only corpus stats](../adr/009-public-readonly-corpus-stats-surface.md), [Design-022 Page-Aware Copilot/SP-4](./022-galaxy-map-copilot.md)
