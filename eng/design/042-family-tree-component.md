...
**Related:** [Design-036 Path Graph Rendering](./036-path-graph-rendering.md), [Design-011 Mobile Web UX](./011-mobile-web-ux.md), [Design-041 SP-4 Page Control AGUI Frontend Tools](./041-sp-4-page-control-agui-frontend-tools.md), [ADR-004 MudBlazor Deviations](../adr/004-mudblazor-deviations.md), [donatso/family-chart](https://github.com/donatso/family-chart)
...
Per [ADR-004](../adr/004-mudblazor-deviations.md) the principle of recording library deviations applies — but this is not a *deviation* from family-chart's public API, just a packaging choice. No ADR-004 entry needed.
