...
**Date:** 2026-04-05
**Companion docs:** [004-galaxy-map-architecture.md](../004-galaxy-map-architecture/spec.md), [003-ai-game-master.md](../003-ai-game-master/spec.md)
...
Galaxy-map-specific search that projects hits back onto the 26×20 grid. Documented in [004-galaxy-map-architecture.md](../004-galaxy-map-architecture/spec.md). Defaults to keyword; `?semantic=true` swaps to embedding search via `MapService.SemanticSearchGridAsync`.
