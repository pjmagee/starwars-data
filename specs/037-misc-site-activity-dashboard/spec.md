...
**Companion docs:** [ADR-009 Public read-only corpus-stats surface](../../eng/adr/009-public-readonly-corpus-stats-surface.md), [ADR-001 Internal API Auth](../../eng/adr/001-internal-api-auth.md), [ADR-002 Three-Project Blazor Server + Shared API](../../eng/adr/002-three-project-blazor-server-shared-api.md)
...
5. Cheap and safe under anonymous traffic — no per-request corpus scans against the shared `mongod` ([ADR-009](../../eng/adr/009-public-readonly-corpus-stats-surface.md)).

## Non-goals

- Any write/trigger/admin capability. ETL/job control stays in the Admin app.
- Real-time/exact figures. A periodically-refreshed snapshot is the explicit design point ([ADR-009](../../eng/adr/009-public-readonly-corpus-stats-surface.md)).
- Continuity/realm filtering. These are corpus-infrastructure totals, **exempt from the global filter** per [ADR-009](../../eng/adr/009-public-readonly-corpus-stats-surface.md). The Miscellaneous pages do not subscribe to `GlobalFilterService`.
...
- [ADR-009](../../eng/adr/009-public-readonly-corpus-stats-surface.md) — the architectural decision (public read-only surface, caching, global-filter exemption) this design implements.
