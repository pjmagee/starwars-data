...
**Status:** Partially shipped — Phase A (plain rebuild against the cleaned KG) done. Phases B–E (calendar filter #5, battle-derived presence #6, lifecycle transitions #7, precise conflict.start/end spanning #8, `TemporalExplicit` refinement #9/E) are **not** built; these remain the tracked "Known gaps" in [004-galaxy-map-architecture.md](../004-galaxy-map-architecture/spec.md).
**Date:** 2026-04-03
