...
| [eng/adr/003-kg-query-architecture.md](../../eng/adr/003-kg-query-architecture.md) | Added Gap 1 section referencing this design |
...
- [ADR-003: KG Query Architecture](../../eng/adr/003-kg-query-architecture.md) — §Gaps vs MongoDB best practices §Gap 1
- [Design-007: KG Bidirectional Edges View](../007-kg-bidirectional-edges-view/spec.md) — sibling work on `reverseLabel` denormalization
