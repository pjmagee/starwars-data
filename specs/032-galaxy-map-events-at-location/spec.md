...
**Related:** [Design-004 Galaxy Map Architecture](../004-galaxy-map-architecture/spec.md), [Design-030 Citation Link Resolver](../030-citation-link-resolver/spec.md), [Design-031 Galaxy Map Deep-Link Route](../031-galaxy-map-deep-link-route/spec.md)
