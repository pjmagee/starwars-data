...
1. Read **all** of [Design-024](../024-typed-node-builders/spec.md) (this doc)
...
- [Design-035 — KG per-type builders](../035-kg-per-type-builders/spec.md) —
  set up the per-type infrastructure that this design now uses.
- [Design-013 — KG property/edge duality](../013-kg-property-edge-duality/spec.md)
  — the framework for deciding what's a property vs an edge.
- [Design-021 — Edge bound provenance](../021-edge-bound-provenance/spec.md) —
  the temporal-bounds story; new edges from this design inherit
  Lifecycle bounds and are refinable by Holocron.
- [Design-023 — Character roles as edges](../023-character-roles-as-edges/spec.md)
