...
**Related:** [Design-018 KG enrichments architecture](../018-kg-enrichments-architecture/spec.md), [Design-019 KG enrichment UI provenance](../019-kg-enrichment-ui-provenance/spec.md), [Design-025 Holocron tool-using agent](../025-holocron-tool-using-agent/spec.md), [Design-026 Holocron orchestration pattern](../026-holocron-orchestration-pattern/spec.md)
...
`kg.edge_enrichments` ([Design-018](../018-kg-enrichments-architecture/spec.md)) carries:
