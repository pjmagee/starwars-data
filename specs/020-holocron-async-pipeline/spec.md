...
Cross-refs: [Design-018 — KG enrichments architecture](../018-kg-enrichments-architecture/spec.md), [Design-019 — KG enrichment UI provenance](../019-kg-enrichment-ui-provenance/spec.md), [ADR-006 — long-running AI workflow pipelines](../../eng/adr/006-long-running-ai-workflow-pipelines.md)
