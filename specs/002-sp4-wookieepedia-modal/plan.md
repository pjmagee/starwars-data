...
- `eng/design/043-sp4-global-tool-family.md` — new design doc capturing the global-tool-family convention.
...
- One new design doc (`eng/design/043-sp4-global-tool-family.md`, ~150 lines).
...
eng/design/
└── 043-sp4-global-tool-family.md          # NEW (graduates the sp4_* convention)

CLAUDE.md                                   # EDIT: reference 042 in the eng/design index
```
...
- **V. Engineering Docs in Sync** — ✅ Gated. `contracts/instructions-delta.md` records the precise prompt block to inline into `CopilotAgent.cs`, and the new `eng/design/043-sp4-global-tool-family.md` is a tasked-out implementation deliverable (in `tasks.md` once generated).
