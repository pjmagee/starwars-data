...
| ADR-003 ([`eng/adr/003-kg-query-architecture.md`](../../eng/adr/003-kg-query-architecture.md)) | Documents denormalization strategy and index ownership |
