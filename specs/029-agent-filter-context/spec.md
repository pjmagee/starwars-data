...
**Related:** [ADR-008 Agent request-scoped filter context](../../eng/adr/008-agent-request-scoped-filter-context.md), [Design-022 Page-Aware Copilot Sidebar](../022-galaxy-map-copilot/spec.md), [ADR-002 AI Agent Toolkits](../../eng/adr/002-ai-agent-toolkits.md)
