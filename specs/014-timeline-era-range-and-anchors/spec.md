...
1. **New third-party dependency** on top of MudBlazor. Per [CLAUDE.md](../../CLAUDE.md) ("Library Deviations") + [ADR-004](../../eng/adr/004-mudblazor-deviations.md), adding a library requires an ADR justification, and the value has to exceed "standard MudBlazor components can't do this".
