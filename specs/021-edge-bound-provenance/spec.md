...
Cross-refs: [Design-001 — Temporal facets](../001-temporal-facets/spec.md), [Design-002 — Edge quality](../002-edge-quality/spec.md), [Design-018 — KG enrichments architecture](../018-kg-enrichments-architecture/spec.md), [Design-020 — Async Holocron pipeline](../020-holocron-async-pipeline/spec.md), [ADR-006 — long-running AI workflow pipelines](../../eng/adr/006-long-running-ai-workflow-pipelines.md)
