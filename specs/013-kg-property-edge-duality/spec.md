...
- [Design 012: AI Agent Tool-Call Efficiency](../012-ai-agent-tool-call-efficiency/spec.md) — earlier session on the 71-call Endor question; the routing discipline proposed there is directly related to the Layer B fix here.
- ADR-002: [AI Agent Toolkits on Microsoft Agent Framework](../../eng/adr/002-ai-agent-toolkits.md).
