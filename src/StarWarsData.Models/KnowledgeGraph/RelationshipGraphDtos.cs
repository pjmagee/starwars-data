...
public class ChunkingProgress
{
    ...
    /// <summary>
    /// Distinct pages that have chunks but no longer satisfy the eligibility
    /// filter (content/infobox cleared, or the page was removed from raw.pages).
    /// These inflate the raw distinct-chunked count and are what previously
    /// drove <see cref="PendingPages"/> negative. Reconcilable via the admin
    /// "Reconcile Orphans" action.
    /// </summary>
    public int OrphanedChunkPages { get; init; }
