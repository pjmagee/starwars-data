...
/// </summary>
internal sealed class ExtractionPageStartedEvent(ExtractionPageStartedData data)
    : WorkflowEvent(data);

internal sealed record ExtractionPageStartedData(string PageTitle, int PageIndex, int TotalPages);
...
/// </summary>
internal sealed class ExtractionPageFailedEvent(ExtractionPageFailedData data)
    : WorkflowEvent(data);

internal sealed record ExtractionPageFailedData(string PageTitle, string Error);
...
/// </summary>
internal sealed class BatchExtractionStartedEvent(BatchExtractionStartedData data)
    : WorkflowEvent(data);
...
/// </summary>
internal sealed class BatchExtractionEmptyEvent(BatchExtractionEmptyData data)
    : WorkflowEvent(data);
...
/// </summary>
internal sealed class BatchExtractionFailedEvent(BatchExtractionFailedData data)
    : WorkflowEvent(data);
...
/// </summary>
internal sealed class ConsolidationCompleteEvent(ConsolidationCompleteData data)
    : WorkflowEvent(data);
